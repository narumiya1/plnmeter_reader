...
@Database(entities = {Gspinner.class,GIndeksSpinner.class,Gimage.class,GCameraValue.class, GUserData.class,GmeterApi.class,Ghistoryi.class, GimageUploaded.class}, version = 11)
