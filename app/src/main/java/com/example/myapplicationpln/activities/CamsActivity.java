...
import com.example.myapplicationpln.fragment.ViewImageActivitiy;
...
public class CamsActivity extends AppCompatActivity {
    ...
    private static final String TAG = CamsActivity.class.getSimpleName();
    ...
    private ImageSwitcher switcher1, switcher2, switcher3, switcher4, switcher5, switcher6;
    private ImageView imgOverlay;
    private HashMap<String, ArrayList<Integer>> overlayScenes;
    private ArrayList<Integer> portrait, signature, interaction, candid, environment, rectangle;
...
//                switcher6.setFactory(new ViewSwitcher.ViewFactory() {
//                    @Override
//                    public View makeView() {
//                        ImageView imageView = new ImageView(getApplicationContext());
//                        imageView.setScaleType(ImageView.ScaleType.CENTER_INSIDE);
...
//                switcher6.setImageResource(R.drawable.ic_circular);
    ...
    public void openImage() {
        Intent sendFileAddressIntent = new Intent(this, ViewImageActivitiy.class);
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if(i != null){
            Log.d("getIntens get"," "+i.getStringExtra(HomeMenuFragment.EXTRA_NOMBRE));
        }
//        sendDatas();
        ...
        capturePictureBtn.getLayoutParams().width = 100;
        capturePictureBtn.getLayoutParams().height = 100;
        capturePictureBtn.setY(100);
        capturePictureBtn.setX(100);
                    ...
                    case MotionEvent.ACTION_UP:
                        ...
                        if (!isRecording) {
                            if ((t2 - t1) >= CLICK_DURATION) {
                                ...
                                capturePictureBtn.setImageResource(R.drawable.ic_selected_circular);
    ...
    private void sendDatas() {
        ...
        HomeMenuFragment myFragment = new HomeMenuFragment();
    ...
    private void hideSceneIcons() {
        runOnUiThread(new Runnable() {
            ...
            public void run() {
                ...
                switcher6.setVisibility(View.INVISIBLE);
    ...
    private void showSceneIcons() {
        runOnUiThread(new Runnable() {
            ...
            public void run() {
                ...
                switcher6.setVisibility(View.VISIBLE);
    ...
    private void initializeScenes() {
        portrait = new ArrayList<Integer>() {
            {
                add(R.drawable.line_background_whte);
                add(R.drawable.line_background_whte);
                add(R.drawable.line_background_whte);
                add(R.drawable.line_background_whte);
                add(R.drawable.line_background_whte);
        ...
        signature = new ArrayList<Integer>() {
            {
                add(R.drawable.line_background);
                add(R.drawable.line_background);
                add(R.drawable.line_background);
                add(R.drawable.line_background);
                add(R.drawable.line_background);
        ...
        interaction = new ArrayList<Integer>() {
            {
                add(R.drawable.line_background_orange);
                add(R.drawable.line_background_orange);
                add(R.drawable.line_background_orange);
            }
        };
        ...
        candid = new ArrayList<Integer>() {
            {
                add(R.drawable.line_background2);
                add(R.drawable.line_background2);
                add(R.drawable.line_background2);
            }
        };

//        rectangle = new ArrayList<Integer>() {
//            {
//                add(R.drawable.rectangle);
//                add(R.drawable.rectangle);
//                add(R.drawable.rectangle);
//            }
//        };
    ...
    public void swipeScenes(Integer nextScene, Integer prevScene) {
        ...
        switch (nextScene) {
            ...
            case 4:
                ...
                break;
//            case 5:
//                switcher6.setImageResource(R.drawable.ic_selected_circular);
//                swipeText.setText("Rectangle");
//                imgOverlay.setImageResource(overlayScenes.get("Rectangle").get(0));
//                break;
            default:
                selectedScene = 0;
                switcher1.setImageResource(R.drawable.ic_selected_circular);
